    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>{{__('local.Visits Tracking')}}</h3>
                <p class="text-subtitle text-muted">{{__('local.Manage and track all visits')}}</p>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title mb-0">{{__('local.Visits Schedule')}}</h5>
            ...
            <div class="card-body">
                    <table class="table table-sm" id="visit_table">
                        <thead>
                            <tr>
...
<script>
    ...
    @vite('resources/static/js/pages/visitsTable.js')
@endsection
