...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            ...
            <h3>{{ __('local.Visits for :name', ['name' => $doctor->full_name]) }}</h3>
               <p class="text-subtitle text-muted">{{ __('local.Visits assigned to this doctor') }}</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('doctors.show', $doctor->id) }}">{{ $doctor->full_name }}</a></li>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title mb-0">{{ __('local.Visits Schedule for :name', ['name' => $doctor->full_name]) }}</h5>
            ...
            <div class="card-body">
                    <table class="table table-sm" id="doctor-visits_table">
                        <thead>
                            <tr>
...
<script>
    ...
    @vite('resources/static/js/pages/doctorAllVisits.js')
@endsection
